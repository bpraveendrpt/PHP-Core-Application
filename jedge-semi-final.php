    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <tfoot>
                ...
                <td class='text-center'>  <a href='#' data-toggle='modal' data-target='#viewSemiProjectModel_Business _".$row["id"]."'>
                ...
                <div class="modal fade" id="viewSemiProjectModel_Business<?php echo $row['id'] ?>"
            ...
            <tfoot>
                ...
                <i class='fa fa-external-link-alt'></i></a> | <a href='#' data-toggle='modal' data-target='#viewSemiProjectModel_Technology_".$row["id"]."'>
                <i class='fas fa-eye'></i></a> </td>
             
   
                </tr>" ?>
                <div class="modal fade" id="viewSemiProjectModel_Technology_<?php echo $row['id'] ?>"
                    tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
