    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <tfoot>
                ...
                <i class='fa fa-external-link-alt'></i></a> | <a href='#' data-toggle='modal' data-target='#viewfinalProjectModel_Technology_".$row["id"]."'>
                <i class='fas fa-eye'></i></a> </td>
             
   
                </tr>" ?>
                <div class="modal fade" id="viewfinalProjectModel_Technology_<?php echo $row['id'] ?>"
            ...
            <tfoot>
                ...
                <td>" . $row["projectType"] . "</td>
                <td class='text-center'> <a href='#' data-toggle='modal' data-target='#roundProjectModel_" . $row["id"] . "'>
                <i class='fa fa-external-link-alt'></i></a> | <a href='#' data-toggle='modal' data-target='#viewFinalProjectModel_Business".$row["id"]."'>
                <i class='fas fa-eye'></i></a> </td>
             
   
                </tr>" ?>
                <div class="modal fade" id="viewFinalProjectModel_Business _<?php echo $row['id'] ?>"
                    tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
